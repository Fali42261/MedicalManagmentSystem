...
The production-layered .NET 8 solution is under `backend/`. Login, signup, JWT authentication, database-driven sidebar permissions and the Medicines CRUD module are connected to the React application through `VITE_BACKEND_API_BASE_URL`. See `backend/README.md` for SQL Server setup and secure configuration.
